...
export const Address: React.FC = () => {
  ...
  return (
    <div className="wrapper animate-fade-in py-5">
      {/* Theme Toggle Button */}
      <button
        type="button"
            ...
            <div className="page-card p-4 shadow bg-white rounded-4">
              ...
              <form onSubmit={handleSubmit(handleLocationSubmit)}>
                <div className="mb-3">
                  ...
                  <input
                    className={`form-control custom-input ${errors.street ? 'is-invalid' : ''}`}
                    type="text"
                    {...register('street')}
                  />
        ...
        {currentPage === 3 && (
          <div className="page active" id="page3">
            <div className="page-card p-4 shadow bg-white rounded-4">
              ...
              <div
                className="add-new border border-dashed text-center py-3 rounded-3 cursor-pointer text-orange fw-bold"
                onClick={() => setCurrentPage(2)}
                style={{ cursor: 'pointer' }}
              >
