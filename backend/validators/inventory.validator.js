...
const ALLOWED_UNITS = Object.freeze(['kg', 'g', 'litre', 'ml', 'piece', 'pack', 'liter', 'box', 'gram']); // Combined units
...
const validateCreateInventory = (req, res, next) => {
  // Map minQuantity to minimumStock for validator compatibility
  if (req.body && req.body.minQuantity !== undefined && req.body.minimumStock === undefined) {
    req.body.minimumStock = req.body.minQuantity;
  }
