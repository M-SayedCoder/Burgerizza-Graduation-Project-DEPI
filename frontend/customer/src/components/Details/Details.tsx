...
export const Details: React.FC = () => {
    ...
    return (
      <div className="container py-5 text-center">
        ...
        <div className="d-flex justify-content-center gap-3 mt-3">
          <button type="button" className="btn btn-orange rounded-pill px-4" onClick={fetchItem}>
            Retry
          </button>
          <Link to={ROUTES.MENU} className="btn btn-outline-secondary rounded-pill px-4">
            Back to Menu
          </Link>
        </div>
      </div>
  ...
  return (
    <section className="meal-details details-view-container py-4">
      <div className="container shadow-lg rounded-4 p-4 p-md-5 bg-white animate-fade-in">
        ...
        <div className="row g-5">
          <div className="col-12 col-lg-6 py-3 border-bottom border-2">
            ...
            <div className="d-flex gap-3 details-action-buttons">
              <button
          ...
          <div className="col-12 col-lg-6 py-3 py-lg-5">
            ...
            {/* Badges */}
            <div className="d-flex gap-2 flex-wrap justify-content-between fw-semibold py-3 border-bottom border-2 pb-4">
