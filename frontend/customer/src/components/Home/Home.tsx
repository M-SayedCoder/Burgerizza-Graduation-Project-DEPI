...
import { handleImageError, handleCategoryImageError } from '../../utils/imageFallback';
        ...
        <div className="container">
          ...
          {loading ? (
            ...
            <div className="text-center py-5">
              <div className="alert alert-danger d-inline-block px-4 py-3 rounded-3 mb-3">
                <i className="bi bi-exclamation-triangle-fill me-2" />
                {error}
              </div>
              <div>
                <button className="btn btn-orange rounded-pill px-4" onClick={refetch}>
                  Retry
                </button>
              </div>
            </div>
